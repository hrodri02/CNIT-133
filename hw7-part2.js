        ...
        document.getElementsByClassName("content-container")[0].innerHTML += `
            <main>
                ...
                <ul class="horizontal-nav-bar">
                    ...
                    <li class="dropdown"><a class="dropbtn" href="#">Homework 4</a>
                    <ul class="submenu fallback">
                            <li><a href="hw4.html">Home</a></li>
